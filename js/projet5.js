...
class Magicien extends Personnage {
    ...
    coupSpecial(personnage) {
        ...
        console.log(this.pseudo + " attaque avec un coup spécial puissance des arcanes " + personnage.pseudo + "  (" + (this.attaque * 5) + " dégâts).");
        this.evoluer();
        personnage.verifierSante();
    }
}
...
class Guerrier extends Personnage {
    ...
    coupSpecial(personnage) {
        personnage.sante -= this.attaque * 5;
        console.log(this.pseudo + " attaque avec un coup spécial haches de guerre " + personnage.pseudo + "  (" + (this.attaque * 5) + " dégâts).");
        this.evoluer();
        personnage.verifierSante();
    }
}
